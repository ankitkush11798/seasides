...
export const villages = [
  {
    ...
    days: { day1: false, day2: false, day3: true },
    icon: Bot,
    url: '/ai-village',
  ...
  },
  {
    ...
    shortName: 'CyberX',
    description:
      'A Multi-Domain Cybersecurity Hacking Ecosystem exploring Real Systems, Real Devices, and Real Attack Surfaces - from Hardware & OT to Aerospace & Space.',
    location: 'Advanced Research Labs',
    days: { day1: false, day2: false, day3: true },
    icon: Shield,
    url: '/cyberxvillage',
    ...
    topics: ['Hardware Hacking', 'ICS Hacking', 'IoT Hacking', 'IoMT Hacking', 'Drone Hacking', 'Satellite Hacking'],
    sessions: {},
    team: []
  },
  {
  ...
  },
  {
    ...
    days: { day1: false, day2: true, day3: false },
    icon: Code2,
  ...
  {
    id: 'dj-hacking',
    name: 'DJ Hacking Village',
    shortName: 'DJ Hacking',
    description:
      'A high-energy sunset experience curated by DJ RAMA. Blending genre-mixing, live DJ techniques, and crowd-driven music hacking.',
    location: 'Main Stage',
    days: { day1: true, day2: true, day3: true },
    icon: Disc,
    url: '/dj-hacking',
    ...
    schedule: {
      day1: { start: '05:00 PM', end: '07:00 PM' },
      day2: { start: '05:00 PM', end: '07:00 PM' },
      day3: { start: '05:00 PM', end: '07:00 PM' }
    },
    topics: ['Genre Hacking', 'Live Remixing', 'Energy Manipulation', 'Crowd Reading', 'Tech & Vibe'],
    sessions: {},
    team: []
  },
  {
    ...
    name: 'Mentor Connect',
    shortName: 'Mentor',
    description: 'Connect with industry experts, get career guidance, and build your professional network.',
    location: 'Networking Lounge',
    days: { day1: true, day2: true, day3: true },
    icon: Users,
    url: '/mentor-connect', // Assuming a page might exist or just placeholder
    ...
    topics: ['Career Guidance', 'Networking', 'Industry Insights', 'Professional Development', 'Mentorship'],
    sessions: {
      day1: [
        {
          time: '05:00 PM',
    ...
    team: [
      { name: 'Karuna Singh', role: 'Mentor' },
      { name: 'Binit Sharma', role: 'Mentor' },
      { name: 'Deepak Rathore', role: 'Mentor' },
      { name: 'Satyendra Prajapati', role: 'Mentor' },
      { name: 'Sartaj Shaikh', role: 'Mentor' }
    ]
  },
  {
    id: 'avatao-labs',
    name: 'Practice with Avatao Labs',
    shortName: 'Avatao Labs',
    description: 'Master secure coding with interactive challenges and hands-on labs powered by Avatao.',
    ...
    topics: ['Secure Coding', 'Vulnerability Patching', 'AppSec', 'Defensive Programming'],
    sessions: {},
    team: []
  },
  {
    id: 'web-trainings',
    name: 'Web Security Trainings',
    shortName: 'Web Trainings',
    description:
      'Comprehensive training sessions on modern web application security, exploitation, and defense strategies.',
    ...
    topics: ['OWASP Top 10', 'API Security', 'Client-side Attacks', 'Web Pen-testing'],
    sessions: {},
    team: []
  }
];
