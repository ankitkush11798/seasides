export const speakers = [
  ...
  {
    id: 'samiul-hussain',
    name: 'Samiul Hussain Mazumder',
    role: 'Security Professional',
    company: '',
    bio: '',
    image: '/speakers/samiul-hussain.jpg',
    social: {
      linkedin: 'https://www.linkedin.com/in/samiul-hussain-mazumder-9a6b951a3/'
    }
  },
  {
...
export const trainingSessions = [
  ...
  {
    id: 'tr-red-teaming',
    title: 'Red Teaming Launchpad',
    date: 'February 21, 2026',
    speakerIds: ['samiul-hussain', 'siddharth-tripathi'],
    description:
      'Red Teaming On Steroids Breaking into AD is an intermediate, hands-on training built around a realistic company environment called ZenithCorp, hosted on Enciphers’ VantagePoint platform.',
    fullDescription:
