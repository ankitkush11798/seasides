...
const About = () => {
  ...
  return (
    <section id="about" className={`relative py-20 scroll-mt-24 overflow-hidden ${isDark ? 'bg-black' : 'bg-white'}`}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              >
                ...
                >
                  About The <span className="text-sunset-orange">Conference</span>
                </h2>
              </motion.div>
              ...
              >
                <p className={`text-lg leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                  To stay ahead in the ever-evolving security landscape, continuous learning and networking are
                  essential. As attacks grow more complex, sharpening our skills is crucial. Cybersecurity conferences
                  are a powerful way to keep up with this fast-changing domain.
                </p>
                ...
                <p className={`text-lg leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                  ...
                  <span className={`font-bold ${isDark ? 'text-purple-400' : 'text-purple-600'}`}>
                    Seasides InfoSec Conference 2026
                  </span>
                  , where you&apos;ll gain valuable insights into cybersecurity. We&apos;re proud to offer top-notch
                  training sessions for free, bringing a community-driven experience that mirrors major global events
                  like <span className={`font-bold ${isDark ? 'text-pink-400' : 'text-pink-600'}`}>Blackhat</span> and{' '}
                  <span className={`font-bold ${isDark ? 'text-green-400' : 'text-green-600'}`}>Defcon</span>—ensuring
              ...
              >
                {features.map((feature, index) => (
                  ...
                  >
                    <div className={`w-2 h-2 rounded-full ${feature.color} mr-2`} />
                    {feature.label}
                  </motion.div>
                ))}
              </motion.div>
            ...
            >
              ...
              <div className="relative h-96 flex items-center justify-center">
                ...
                >
                  ...
                  {/* Pulsing Ring */}
                  <div className="absolute inset-0 rounded-full bg-sunset-orange animate-ping opacity-20" />
                </motion.div>
                ...
                {[
                  ...
                  >
                    <div
                      className={`w-16 h-16 rounded-full ${node.color} flex items-center justify-center ${
                    ...
                    {/* Connection Lines */}
                    <div
                      className={`absolute top-8 left-8 w-32 h-px ${node.color} opacity-30`}
                      style={{
                ...
                >
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      <div className="w-3 h-3 rounded-full bg-sunset-orange animate-pulse" />
