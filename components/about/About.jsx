            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className={`text-xl leading-relaxed mb-8 ${isDark ? 'text-gray-200' : 'text-gray-700'}`}>
                  In 2019, a group of passionate cybersecurity enthusiasts recognized a critical gap in the industry –
                  quality security education was becoming a privilege, not a right. Too many brilliant minds were being
                  left behind due to financial barriers.
                </p>

                <p className={`text-lg leading-relaxed mb-8 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                  Seasides emerged from the null security community in India, inspired by a simple yet revolutionary
                  idea: what if world-class cybersecurity education was completely free? What if anyone, regardless of
                  their background or financial situation, could access the same high-quality training that was
                  previously available only to the privileged few?
                </p>

                <blockquote
                  className={`text-2xl font-bold italic mb-8 p-6 rounded-lg border-l-4 ${
                    isDark
              ...
              <div className="grid grid-cols-1 gap-8">
                <div className={`p-8 rounded-2xl ${isDark ? 'bg-gray-700/50' : 'bg-white'} shadow-lg`}>
                  <div className="text-5xl font-black mb-4" style={{ color: colors.sunsetOrange }}>
                    2019
                  </div>
                  <h4 className={`text-xl font-bold mb-2 ${isDark ? 'text-white' : 'text-gray-900'}`}>Founded</h4>
                  <p className={`${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                    Born from the null security community
                  </p>
                </div>

                <div className={`p-8 rounded-2xl ${isDark ? 'bg-gray-700/50' : 'bg-white'} shadow-lg`}>
                  <div className="text-5xl font-black mb-4" style={{ color: colors.deepOceanBlue }}>
                    100%
                  </div>
                ...
                <div className={`p-8 rounded-2xl ${isDark ? 'bg-gray-700/50' : 'bg-white'} shadow-lg`}>
                  <div className="text-5xl font-black mb-4" style={{ color: colors.sunnyYellow }}>
                    5000+
                  </div>
                  <h4 className={`text-xl font-bold mb-2 ${isDark ? 'text-white' : 'text-gray-900'}`}>
                    Students Impacted
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className={`text-xl leading-relaxed max-w-4xl mx-auto ${isDark ? 'text-gray-200' : 'text-gray-700'}`}>
                Our mission transcends traditional conference boundaries. We&apos;re building a movement that transforms
                how cybersecurity education is delivered, consumed, and scaled across communities.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              <div className={`p-8 rounded-2xl text-center ${isDark ? 'bg-gray-800/60' : 'bg-white'} shadow-lg`}>
                ...
                >
                  <svg
                    className={`w-8 h-8`}
                    style={{ color: isDark ? colors.sunsetOrange : colors.deepOceanBlue }}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
              ...
              <div className={`p-8 rounded-2xl text-center ${isDark ? 'bg-gray-800/60' : 'bg-white'} shadow-lg`}>
                ...
                >
                  <svg
                    className={`w-8 h-8`}
                    style={{ color: isDark ? '#60a5fa' : colors.deepOceanBlue }}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
