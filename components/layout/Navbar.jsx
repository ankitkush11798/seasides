          ...
          <div className="space-y-1">
            ...
            >
              <div className="flex items-center">
                <div
                  className={`w-8 h-8 rounded-lg flex items-center justify-center mr-3 ${
                    isDark ? 'bg-gray-700 group-hover:bg-purple-500/20' : 'bg-purple-100 group-hover:bg-purple-200'
                  }`}
                >
            ...
            >
              <div className="flex items-center">
                <div
                  className={`w-8 h-8 rounded-lg flex items-center justify-center mr-3 ${
                    isDark ? 'bg-gray-700 group-hover:bg-amber-500/20' : 'bg-amber-100 group-hover:bg-amber-200'
                  }`}
                >
