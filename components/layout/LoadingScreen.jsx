    ...
    >
      ...
      >
          ...
          {[...Array(8)].map((_, i) => (
            <div
              ...
              className={`absolute w-1 bg-gradient-to-t ${
                isDark ? 'from-orange-400 to-transparent' : 'from-yellow-300 to-transparent'
              }`}
              style={{
                height: '60px',
                left: '50%',
        ...
        <div
          className={`absolute inset-4 rounded-full ${
            isDark ? 'bg-gradient-to-br from-yellow-300 to-orange-400' : 'bg-gradient-to-br from-white to-yellow-200'
          } animate-pulse`}
        />
      </div>
      ...
      {!isMobile && (
        <div className="absolute inset-0">
          <div
            className={`absolute w-24 h-12 rounded-full opacity-60 ${isDark ? 'bg-orange-600/40' : 'bg-orange-200/70'}`}
            style={{
              top: '15%',
              left: '10%',
          ...
          />
          <div
            className={`absolute w-32 h-16 rounded-full opacity-40 ${isDark ? 'bg-orange-500/30' : 'bg-orange-100/80'}`}
            style={{
              top: '25%',
              left: '70%',
          ...
          />
          <div
            className={`absolute w-20 h-10 rounded-full opacity-50 ${isDark ? 'bg-orange-600/35' : 'bg-orange-200/75'}`}
            style={{
              top: '35%',
              left: '40%',
