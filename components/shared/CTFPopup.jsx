        ...
        <>
          ...
          >
            ...
            <motion.div
              ...
              className="relative w-full max-w-xl overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-[#0a0a0a] to-[#1a1a1a] shadow-2xl shadow-blue-900/20"
            >
              {/* Decorative elements */}
